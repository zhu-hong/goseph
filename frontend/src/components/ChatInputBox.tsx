...
export function ChatInputBox() {
  ...
  return  <div className="flex-none flex justify-between items-center dark:text-white">
    ...
    <button
      ...
      className="flex-none w-48px h-48px ml-2 rounded-full grid place-items-center text-gray-700 dark:text-gray-400 transition active:(bg-gray-400 dark:bg-dark-700)"
    >
